...
![An illustration of the supermarket dynamics.](figures/chapter_1/fig_intro_1){#fig-supermarket-dynamics}
...
![Transition dynamics between neighboring states](figures/chapter_1/fig_intro_2){#fig-transition-neighboring width=70%}
...
![The traveling salesman has to find a good and practical solution](figures/chapter_1/fig_intro_3){#fig-tsp-1 width=70%}
